...
function processTextboxText(node, text)
  ...
  announce("Processing text with AI for high-level professional conversion.")
  
  local savedTypingMode = typingMode
  typingMode = "Professional Writer Mode"
  
  local professionalUserCommand = "You are an ULTRA-PREMIUM PROFESSIONAL TEXT ENHANCEMENT AI. Transform the following text into HIGHEST QUALITY PROFESSIONAL CONTENT. Fix grammar, upgrade vocabulary to sophisticated professional level, add proper punctuation, use professional tone, add transitions where needed. Keep same meaning. Return ONLY the enhanced text. NO explanations, NO prefixes.\n\nText: " .. text
